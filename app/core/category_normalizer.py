...
CATEGORY_MAPPINGS = {
    ...
    "afp_photo": {
        # AFP Photo categories - all photos are categorized as photos
        "عکس": "photos",
        "Photo": "photos",
        "Photos": "photos",
        "Picture": "photos",
        ...
        "Society": "society",
        "Social": "society",
        # Default to photos for AFP photo
        "News": "photos",
        "Top News": "photos",
        "Breaking News": "photos",
    },
    "afp_video": {
        # AFP Video categories - all videos are categorized as videos
        "ویدئو": "videos",
        "Video": "videos",
        "Videos": "videos",
        # But also support other categories if provided
        ...
        "Society": "society",
        "Social": "society",
        # Default to videos for AFP video
        "News": "videos",
        "Top News": "videos",
